...
// Helper function to get labeled CPU core sensors for the current CPU model
...
double smctemp::SmcTemp::GetGpuTemp() {
  ...
  // Get sensor pairs from the helper function
...
#elif defined(ARCH_TYPE_ARM64)
  // Get the labeled sensors from our helper function
  auto labeled_sensors = GetCpuCoreSensors();
...
#elif defined(ARCH_TYPE_ARM64)
  // Get sensor mapping from the helper function
  auto labeled_sensors = GetGpuCoreSensors();
